...
$stid5 = oci_parse($koneksi, 'select count(*) as JUM from sewa');
oci_execute($stid5);
$total5 = oci_fetch_array($stid5,OCI_BOTH);
?>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            ...
            <!-- Pending sewa Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                    <a class="card-category">Sewa</a>
                  <h3 class="card-title"><?php echo $total5['JUM'];?>
                    <span>Poses</span>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-users fa-2x text-info"></i>
