            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Form Data petugas</h6>
                </div>
                <div class="card-body">
                  <form method='post' action='aksi_petugas.php?act=input'>
                  <div class="form-group">
                      <label for="petugas">ID Petugas</label>
                      <input type="number" class="form-control" name="id_petugas" placeholder="masukkan id">   
                    </div>
                    <div class="form-group">
