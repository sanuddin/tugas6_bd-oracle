		  ...
		  <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method='post' action='aksi_mobil.php?act=input'>
                  <div class="form-group">
                      <label for="id_mobil">ID Mobil</label>
                      <input type="number" class="form-control" name="id_mobil" placeholder="masukkan id">
                      </div>
                    <div class="form-group">
                      <label for="plat_nomor">Plat nomor</label>
                      <input type="text" class="form-control" name="plat_nomor" placeholder="masukkan nomor">
                      </div>
                    <div class="form-group">
