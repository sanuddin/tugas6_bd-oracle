      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-left justify-content-between mb-6">
            <h1 class="h3 mb-4 text-gray-800">Tambah Data Pelanggan</h1>
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Form Data Pelanggan</h6>
                </div>
                <div class="card-body">
                  <form method='post' action='aksi_pelanggan.php?act=input'>
                  <div class="form-group">
                      <label for="nama">ID Pelanggan</label>
                      <input type="number" class="form-control" name="id_pelanggan" placeholder="masukkan id">
                      </div>
                    <div class="form-group">
